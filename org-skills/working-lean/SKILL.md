...
Claude does not remember your conversation between messages the way a colleague does. Every time
you send a message, **the entire conversation so far is sent again**. Every earlier question,
every answer, and the full text of everything you have attached goes up with it.

So a short question at 4pm in a conversation you started at 9am is not a short question. It
carries the whole morning with it.

Two things follow, and everything below is one of them:

1. **What you attach, you pay for on every later message**, not once.
2. **Irrelevant material is not harmless.** It competes for attention with the part that matters.
   Independent testing across eighteen different AI models found that adding even one piece of
   irrelevant material to what the model was given measurably reduced accuracy. A long conversation
   carrying four unrelated matters is not a tidy filing system. It is four distractions.

## One matter, one conversation

Start a new chat when the subject changes. A conversation about a section 20 consultation at
Property A should not later be asked about a service charge query at Property B.

The signs you have stayed too long in one conversation:

- It starts repeating things it already told you.
- It loses a detail you gave it earlier.
