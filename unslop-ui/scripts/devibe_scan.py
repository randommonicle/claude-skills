...
# Windows consoles default to cp1252 and raise UnicodeEncodeError when a snippet contains an
# emoji; force UTF-8 so the report prints on every platform.
try:
...
# Emoji ranges (pictographs, emoticons, transport, dingbats, misc symbols) so the
# emoji-as-icons rule matches any emoji, not a hand-picked handful.
EMOJI = ("\U0001F300-\U0001FAFF\U00002600-\U000026FF\U00002700-\U000027BF"
         "\U0001F000-\U0001F0FF\U00002B00-\U00002BFF\U00002764")
